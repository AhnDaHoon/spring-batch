...
//                .processor()
    ...
    private List<Person> getItems() {
        ...
        for (int i = 0; i < 10; i++) {
            items.add(new Person(i+1, "test name"+i, i+10, "test address"+i));
        }
    ...
    public JdbcCursorItemReader<Person> jdbcCursorItemReader() throws Exception {
        JdbcCursorItemReader<Person> itemReader = new JdbcCursorItemReaderBuilder<Person>()
                ...
                .sql("select id, name, age, address from spring_batch.person")
    ...
    @Bean
    Step jdbcStep() throws Exception {
    ...
    public JpaCursorItemReader<Person> jpaCursorItemReader() throws Exception {
